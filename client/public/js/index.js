...
const contentInfo = document.querySelectorAll(".content-info > h1");
...
function animate () {
    ...
    // log (contentScale)
    // if (contentScale <= -3) {
    //     document.querySelector(".content-desc > h1").style.transform = `rotateX(90deg)`;
    // } else {
    //     document.querySelector(".content-desc > h1").style.transform = `rotateX(0deg)`;
    // }

    // contentScale = contentScale < 0 ? 0 : contentScale > 1 ? 1 : contentScale;
